...
namespace ProgrammeManagementSystem.Controllers
{
    public class RegistrationsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Registrations.Include(r => r.Module).Include(r => r.Student);
        ...
        public async Task<IActionResult> Create([Bind("RegistrationID,StudentID,ModuleID")] Registration registration)
        {
            ...
            ViewData["ModuleID"] = new SelectList(_context.Modules, "ModuleID", "ModuleID", registration.ModuleID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RegistrationID,StudentID,ModuleID")] Registration registration)
        {
